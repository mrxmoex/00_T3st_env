...
import { scoreAllFoods } from "./scoring/engine.js";
import { DATASET_VERSION, LAST_VERIFICATION_DATE, COEFFICIENT_VERSION, } from "./data/version.js";
...
export function getAllScored(pattern = "omnivore") {
